...
module.exports = {
  activate() {
    ...
    // holds focus. The picker reads the active editor throughout, so there has
    // to be one before it opens.
    commandSubscription = atom.commands.add("atom-workspace", "encoding-selector:show", () => {
