...
module.exports = {
  activate() {
    ...
    // holds focus. The picker reads the active file editor throughout — the
    // encoding is a property of the file, so inside a notebook it describes
    // the backing .ipynb — and there has to be one before it opens.
